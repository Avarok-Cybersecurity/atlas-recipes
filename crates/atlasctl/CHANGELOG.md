...
## [0.5.0](https://github.com/Avarok-Cybersecurity/atlas-recipes/compare/v0.4.0...v0.5.0) (2026-09-17)
...
* **atlasctl:** bench fetch places an artifact at its manifest path, not its manifest key ([#176](https://github.com/Avarok-Cybersecurity/atlas-recipes/issues/176)) ([765b30c](https://github.com/Avarok-Cybersecurity/atlas-recipes/commit/765b30c72524e36cab0b5640591d0b31052475ef))
...
* The following workspace dependencies were updated
  * dependencies
    * atlasctl-protocol bumped from 0.4.2 to 0.5.0
